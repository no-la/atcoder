...
def op_segtree(s:SegTree, t:SegTree):
    par = SegTree(H, 0, lambda l, r: l+r)
    for i in range(H):
        par.update(i, s.get_point(i)+t.get_point(i))


H, W, K = map(int, input().split())
S = [input() for _ in range(H)]

st = SegTree(W, SegTree(H, 0, lambda l, r: l+r), op_segtree)